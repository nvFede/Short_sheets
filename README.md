...
return false; }) $('.pin-custom-btn').click(function() {
...
window.open('https://twitter.com/intent/tweet?url=' +encodeURIComponent(document.URL) + '&text=' +encodeURIComponent(document.title)); return false; });
...
$('.wsp-custom-btn').click(function() { window.open('whatsapp://send?text='encodeURIComponent(document.URL) + '&title='encodeURIComponent(document.title)); return false; });
```
